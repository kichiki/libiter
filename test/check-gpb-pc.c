/* test code for gpb_pc() in bi-cgstab.c
 * Copyright (C) 2007 Kengo Ichiki <kichiki@users.sourceforge.net>
 * $Id: check-gpb-pc.c,v 1.1 2007/12/01 18:10:29 kichiki Exp $
 *
	      ...
	      int verbose, double tiny)
{
  ...
  CHECK_MALLOC (a,  "check_gpb_pc");
  CHECK_MALLOC (b,  "check_gpb_pc");
  CHECK_MALLOC (x,  "check_gpb_pc");
  CHECK_MALLOC (x_, "check_gpb_pc");
  CHECK_MALLOC (lu, "check_gpb_pc");
  ...
  struct iter *it
    = iter_init ("gpb", it_max, 0, it_eps, // solver param
		 n, NULL, 0, // guess
		 0, NULL); // debug info
  CHECK_MALLOC (it, "check_gpb_pc");
