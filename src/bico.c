 ...
 * $Id: bico.c,v 2.1 2006/10/09 20:09:24 ichiki Exp $
 *
      ...
      void * user_data)
{
  ...
  rtmr = (double *) malloc (sizeof (double) * n);
  ...
  for (i = 0; i < itmax; i ++)
    {
      ...
      rtmr2 = ddot_ (&n, rtmr, &i_1, rtmr, &i_1); // rtmr2 = (rt - r, rt - r)
      rrtmr = ddot_ (&n, r, &i_1, rtmr, &i_1); // rrtmr = (r, rt - r)
      gamma = - rrtmr / rtmr2;
